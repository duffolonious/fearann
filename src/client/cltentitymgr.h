...
#ifndef __FEARANN_CLIENT_ENTITY_MGR_H__
#define __FEARANN_CLIENT_ENTITY_MGR_H__
...
public:
	/** Get entity */
	CltEntityBase* getEntity( uint64_t id ) { return mEntityList[id]; };
...
private:
	...
	/// Entity list
	std::map<uint64_t, CltEntityBase*> mEntityList;
