...
#ifndef __FEARANN_CLIENT_ENTITY_CREATURE_H__
#define __FEARANN_CLIENT_ENTITY_CREATURE_H__
 ...
 */
class CltEntityCreature : public CltEntityBase
{
public:
...
public: 
	/** Default constructor */
	CltEntityCreature(const MsgEntityCreate* entityBasicData);
	/** Destructor */
	~CltEntityCreature();
